...
/**
 * Builds a spoken-name -> package-name lookup from installed apps,
 * and does simple fuzzy matching so "whats app" / "whatsapp" both work.
 */
class AppResolver(private val context: Context) {
    ...
    fun resolve(spokenName: String): String? {
        ...
        // fallback: closest contains-match
